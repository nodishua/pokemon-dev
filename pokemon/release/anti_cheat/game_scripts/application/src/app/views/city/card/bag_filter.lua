...
function CardBagFilterView:onCreate(params)
	...
	self.attr1 = idler.new(ui.ATTR_MAX)--第一个属性
	self.attr2 = idler.new(ui.ATTR_MAX)--第二个属性
	self.rarity = idler.new(ui.RARITY_LAST_VAL) --品级
	-- 物攻/特攻选中
...
function CardBagFilterView:initData()
	self.attr1:set(ui.ATTR_MAX)--第一个属性
	self.attr2:set(ui.ATTR_MAX)--第二个属性
	self.rarity:set(ui.RARITY_LAST_VAL) --品级
	-- 物攻/特攻选中
	self.atkType:set({
		[game.ATTRDEF_ENUM_TABLE.damage] = true,
		[game.ATTRDEF_ENUM_TABLE.specialDamage] = true,
