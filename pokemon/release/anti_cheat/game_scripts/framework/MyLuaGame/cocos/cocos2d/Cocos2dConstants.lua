...
cc.VERTICAL_RICHTEXT_ALIGNMENT_BOTTOM   = 2
cc.VERTICAL_RICHTEXT_ALIGNMENT_CENTER   = 1
cc.VERTICAL_RICHTEXT_ALIGNMENT_TOP      = 0

cc.HORIZONTAL_RICHTEXT_ALIGNMENT_RIGHT   = 2
cc.HORIZONTAL_RICHTEXT_ALIGNMENT_CENTER  = 1
cc.HORIZONTAL_RICHTEXT_ALIGNMENT_LEFT    = 0
