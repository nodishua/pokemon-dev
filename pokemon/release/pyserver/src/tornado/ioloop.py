...
class IOLoop(Configurable):
    ...
    def run_sync(self, func, timeout=None):
        ...
        # add by huangwei 20150126 run_sync until done or timeout
        # it can be work when run_sync in coroutine
        # https://github.com/tornadoweb/tornado/pull/1314#issuecomment-75400164
        while not self._closing:
            self.start()
            if future_cell[0] is None:
                continue
